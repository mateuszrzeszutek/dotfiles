...
local function ngroup(lhs, group, proxy)
  return { lhs, group = group, proxy = proxy, mode = 'n' }
end

local function nmap(lhs, rhs, desc, buffer)
  return { lhs, rhs, desc = desc, mode = 'n', buffer = buffer }
end

local function xmap(lhs, rhs, desc, buffer)
  return { lhs, rhs, desc = desc, mode = 'x', buffer = buffer }
end
...
return {
  nmap = function(lhs, rhs, desc, buffer)
    wk.add { nmap(lhs, rhs, desc, buffer) }
  end,
  setup = setup,
